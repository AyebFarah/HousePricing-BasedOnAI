    ...
    <div className="min-h-screen bg-gradient-bg">
      ...
      <header className="border-b border-border/40 bg-card/30 backdrop-blur-lg sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">ImmoPredict Tunisie</h1>
              <p className="text-sm text-muted-foreground">Estimation intelligente des prix immobiliers</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="mt-16 animate-in fade-in-50 slide-in-from-bottom-4 duration-700 delay-500">
            <MarketTrends />
          </div>
        </div>
      </main>
      ...
      <footer className="border-t border-border/40 bg-card/30 backdrop-blur-lg mt-16">
        <div className="container mx-auto px-4 py-6">
          <p className="text-center text-sm text-muted-foreground">
            © 2024 ImmoPredict Tunisie - Estimation immobilière par IA
          </p>
        </div>
      </footer>
    </div>
